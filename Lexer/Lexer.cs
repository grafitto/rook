    ...
    public class Lexer {
        ...
        public void Tokenize() {
            while(!this.stream.End()) {
                ...
                if(character.Equals(CharacterTypes.FULL_COLON)) {
                    ...
                    //( (LEFT_BRACKET)
                    tokens.Add(new Token(TokenType.LEFT_BRACKET, character.ToString(), this.stream.Column, this.stream.Row));
                    ...
                    //- (MINUS)
                    tokens.Add(new Token(TokenType.MINUS, character.ToString(), this.stream.Column, this.stream.Row));
                } else if (character.Equals(CharacterTypes.TIMES)) {
                    //* (TIMES)
                    tokens.Add(new Token(TokenType.TIMES, character.ToString(), this.stream.Column, this.stream.Row));
                    ...
                    if(stream.Peek().Equals(CharacterTypes.DIVIDE)) {
                        ...
                        tokens.Add(new Token(TokenType.DIVIDE, character.ToString(), this.stream.Column, this.stream.Row));   
                    }
                } else if (character.Equals(CharacterTypes.MODULUS)) {
                    // % (MODULUS)
                    tokens.Add(new Token(TokenType.MODULUS, character.ToString(), this.stream.Column, this.stream.Row));
                } else if (character.Equals(CharacterTypes.LESS_THAN)) {
                    if(stream.Peek().Equals(CharacterTypes.EQUALS)){
                        //<= 
                        string lessOrEqual = character.ToString() + stream.Next().ToString();
                        tokens.Add(new Token(TokenType.LESS_THAN_OR_EQUAL_TO, lessOrEqual, this.stream.Column, this.stream.Row));
                    } else {
                        //<
                        tokens.Add(new Token(TokenType.LESS_THAN, character.ToString(), this.stream.Column, this.stream.Row));
                    ...
                    if(stream.Peek().Equals(CharacterTypes.EQUALS)){
                        ...
                        tokens.Add(new Token(TokenType.GREATER_THAN_OR_EQUAL_TO, greaterOrEqual, this.stream.Column, this.stream.Row));
                    } else {
                        //>
                        tokens.Add(new Token(TokenType.GREATER_THAN, character.ToString(), this.stream.Column, this.stream.Row));
                    ...
                    if(stream.Peek().Equals(CharacterTypes.EQUALS)){
                        ...
                        tokens.Add(new Token(TokenType.EQUAL_TO, equality, this.stream.Column, this.stream.Row));
                    } else {
                        //<
                    ...
                    if(stream.Peek().Equals(CharacterTypes.EQUALS)) {
                        ...
                        tokens.Add(new Token(TokenType.NOT_EQUAL_TO, notEqualTo, this.stream.Column, this.stream.Row));
                    } else {
                        stream.Error("Character " + character + " not supported");
                    }
                    ...
                    if(stream.Peek().Equals(CharacterTypes.LOGICAL_AND)) {
                        ...
                        tokens.Add(new Token(TokenType.LOGICAL_AND, and, this.stream.Column, this.stream.Row));
                    } else {
                        stream.Error("Character " + character + " not supported");
                    }
                    ...
                    if(stream.Peek().Equals(CharacterTypes.LOGICAL_OR)) {
                        ...
                        tokens.Add(new Token(TokenType.LOGICAL_OR, or, this.stream.Column, this.stream.Row));
                    } else {
                        stream.Error("Character " + character + " not supported");
                    }
                }
            }
            tokens.Add(new Token(TokenType.EOF, "end", this.stream.Column, this.stream.Row));
        }
        public Token Identifier(char character) {
            if(character.Equals('l') && this.stream.Peek().Equals('e') && this.stream.Peek(1).Equals('t') && char.IsWhiteSpace(this.stream.Peek(2))) {
                ...
                return new Token(TokenType.KEYWORD, KeyWords.LET, this.stream.Column, this.stream.Row);
                ...
                return new Token(TokenType.IDENTIFIER, identifier, this.stream.Column, this.stream.Row);
            }
        }
        ...
        private Token Number(char character) {
            ...
            this.stream.Previous();
            return new Token( TokenType.NUMBER, number, this.stream.Column, this.stream.Row);
        }
